...
class AttributeExtractor():
    ...
    def extract_header_fields(self):
        ...
        self.header_attributes["header_size_in_paragraphs"] = dos_header.sizeof_header_in_paragraphs if hasattr(dos_header, 'sizeof_header_in_paragraphs') else None
        ...
        self.header_attributes.update({
            ...
            "Signature": file_header.signature if hasattr(file_header, 'signature') else None,
